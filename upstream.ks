# clone from fedora-live-base.ks
#
...
repo --name=intel --baseurl=https://download.01.org/gfx/fedora/20
repo --name=rpmfusion-1 --mirrorlist=http://mirrors.rpmfusion.org/free/fedora/20/x86_64
repo --name=rpmfusion-2 --mirrorlist=http://mirrors.rpmfusion.org/nonfree/fedora/20/x86_64
repo --name=rpmfusion-3 --mirrorlist=http://mirrors.rpmfusion.org/free/fedora/updates/20/x86_64
repo --name=rpmfusion-4 --mirrorlist=http://mirrors.rpmfusion.org/nonfree/fedora/updates/20/x86_64
